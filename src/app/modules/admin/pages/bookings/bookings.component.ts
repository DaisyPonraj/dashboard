...
import { BookingListService } from './bookings.service';
...
export class BookingListComponent implements AfterViewInit, OnInit {
  formFieldHelpers: string[] = [''];
  data: any;
  constructor(
    private _bookingService: BookingListService,
