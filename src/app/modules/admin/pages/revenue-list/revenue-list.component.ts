...
import { RevenueListService } from './revenue-list.service';
...
export class RevenueListComponent implements AfterViewInit, OnInit {
  formFieldHelpers: string[] = [''];
  data: any;
  constructor(
    private _revenueService: RevenueListService,
