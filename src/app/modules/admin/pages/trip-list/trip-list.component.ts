...
import { TripListService } from 'app/modules/admin/pages/trip-list/trip-list.service';
...
export class TripListComponent implements AfterViewInit, OnInit {
  formFieldHelpers: string[] = [''];
  data: any;
  constructor(
    private _tripService: TripListService,
    private _router: Router,
    private _liveAnnouncer: LiveAnnouncer
  ) {
  }
  displayedColumns: string[] = ['position', 'name', 'weight', 'symbol', 'email', 'trips','status'];
